# Generated by Django 3.2.5 on 2023-04-02 10:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='auction',
            name='heighestBid',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='auction', to='auctions.bid', unique=True),
        ),
        migrations.AddField(
            model_name='auction',
            name='user',
            field=models.ForeignKey(default=2, on_delete=django.db.models.deletion.CASCADE, related_name='owned_auctions', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='auction',
            name='watchlist',
            field=models.ManyToManyField(related_name='watchlist_auctions', to=settings.AUTH_USER_MODEL),
        ),
    ]
